...
<body>
	...
	<div class="container">
		<div class="jumbotron">
			...
			<h2>Détail vente</h2>
			<br> <b><h4>${article.nomArticle}</h4></b><br> <b><label
			...
			crédits</label><br> <b><label class="form-label" for="form9Example4">Fin
				...
				class="form-label" for="form9Example4">Rue :</b> ${rue}</label><br>
			<b><label class="form-label" for="form9Example4">Code
					postal :</b> ${cp}</label><br> <b><label class="form-label"
				for="form9Example4">Ville : </b> ${ville}</label><br> <b>Vendeur
				: </b><a class="card-text"
