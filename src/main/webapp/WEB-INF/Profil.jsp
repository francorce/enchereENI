		...
		<div class="jumbotron">
			<ul class="list-group" style="">
				<li class="list-group-item"
					...
					type="text" value="${userProfil.pseudo}" class="form-control"
					readonly></li>
				<li class="list-group-item"
				...
				<li class="list-group-item"
					...
					type="text" value="${userProfil.prenom}" class="form-control"
					readonly></li>
				<li class="list-group-item"
					style="text-align: left; border-width: 0px;">E-mail :<input
					type="text" value="${userProfil.email}" class="form-control"
					readonly></li>
				<li class="list-group-item"
					style="text-align: left; border-width: 0px;">Téléphone :<input
					type="text" value="${userProfil.telephone}" class="form-control"
					readonly></li>
				<li class="list-group-item"
				...
				<li class="list-group-item"
					...
					type="text" value="${userProfil.ville}" class="form-control"
					readonly></li>
			</ul>
